...
namespace RayTracing2._0.SceneObjects
{
    public class Prism : ISceneObject
    {
        ...
        public Prism(double lenght, IMaterial material)
        {
            _lenght = lenght;
            Material = material;
        ...
        private void CreateTriangle(List<Vector3> vertexes)
        {
            ...
            var a = Math.Acos(1 / (1 + _lenght * _lenght));
            var xRot = Matrix.CreateRotationMatrixX(a);
            var zRot = Matrix.CreateRotationMatrixZ(a);
            ...
            _triangles = new List<Triangle>()
            {
                ...
                new Triangle(vertexes[index1], vertexes[index2], vertexes[index5], new Vector3(1, 0, 0) * zRot),
                new Triangle(vertexes[index2], vertexes[index4], vertexes[index5], new Vector3(0, 0, -1) * xRot),
                new Triangle(vertexes[index4], vertexes[index3], vertexes[index5], new Vector3(-1, 0, 0) * zRot),
                new Triangle(vertexes[index3], vertexes[index1], vertexes[index5], new Vector3(0, 0, +1) * xRot),
            };
        }
