...
public class Prism : ISceneObject
{
    ...
    public Prism(float lenght, IMaterial material)
    {
        ...
        _sphere = new Spheres.Sphere(vector3, lenght, null);
    }
    ...
    private void CreateTriangle(List<Vector3> vertexes)
    {
        ...
        {
            new(vertexes[index1], vertexes[index2], vertexes[index3], new Vector3(0, -1, 0), Material),
            new(vertexes[index2], vertexes[index3], vertexes[index4], new Vector3(0, -1, 0), Material),
            new(vertexes[index1], vertexes[index2], vertexes[index5], Vector3.Transform(new Vector3(1, 0, 0), zRot),
                Material),
            new(vertexes[index2], vertexes[index4], vertexes[index5], Vector3.Transform(new Vector3(0, 0, -1), xRot),
                Material),
            new(vertexes[index4], vertexes[index3], vertexes[index5], Vector3.Transform(new Vector3(-1, 0, 0), zRot),
                Material),
            new(vertexes[index3], vertexes[index1], vertexes[index5], Vector3.Transform(new Vector3(0, 0, +1), xRot),
                Material),
        };
    }
